...
export default function DashboardView({
  nickname, aiAnalysis, isAnalyzing,
  chatInput, setChatInput,
  chatResponse, handleAskAI,
  parsedActivities, setView
}: DashboardViewProps) { 
    return ( 
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <p className="text-slate-500">Welcome back, {nickname || 'Agent'}. Local data synced.</p>
                </header>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <Card className="lg:col-span-2" title="AI Protocol Summary">
                ...
                <div className="pt-6 border-t border-slate-700">
                  ...
                  <div className="bg-slate-950 rounded-lg p-3 font-mono text-xs text-emerald-400 min-h-[60px] border border-slate-800 mb-3 shadow-inner">
                    {chatResponse ? `> ${chatResponse}` : `> Agent ${nickname}, waiting for input...`}
                  </div>
